const translateCT= async(word)=>{
  try {
    ...
    a["е"]="e";a["н"]="n";a["г"]="g";a["ш"]="sh";a["щ"]="sh";a["з"]="z";a["х"]="x";a["ъ"]="'";a["Ф"]="F";
    ...
    a["ҟ"] = "Ё"; a["ѿ"] = "ё"; a["Ѻ"] = "ў"; a["Ѽ"] = "Ў"; a["Ђ"] = "Я"; a["Њ"] = "я"
    for (let i = 0; i < word.length; i++){
      if (word.hasOwnProperty(i)) {
        ...
        if(word[i] === 'G' && (word[i+1] === "'" || word[i+1] === "`" || word[i+1] === "’")){
          let changes = word.split('')
          changes[i] = 'Ğ'
          changes[i+1] = ''
          word = changes.join('')
        ...
        if(word[i] === 'O' && (word[i+1] === "'" || word[i+1] === "`"|| word[i+1] === "’")){
          let changes = word.split('')
          changes[i] = 'Ō'
          changes[i+1] = ''
          word = changes.join('')
